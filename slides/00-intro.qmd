...
::::{.columns}
:::{.column width="60%"}
*Module I (DM&ML; DTM), 30h* (Prof. Francia)

- Goal: Introduction to Machine Learning

*Module II (DM&ML; DTM) = Module I (DCAI; CSE), 30h* (Prof. Golfarelli)
...
- [Lab: pipelines and data augmentation](lab-01-augmentation)
- [Lab: feature engineering](lab-02-feature)
- [Lab: fairness in AI](lab-03-fairness)
- [Lab: AutoML](lab-04-automl)

Part II

- Privacy-aware AI: [theory](01-privacy) and [lab](lab-05-privacy)
- Explainable AI: [theory](02-explainability) and [lab](lab-06-explainability)
- GraphRAG: [theory](03-graphrag) and [lab](lab-07-graphrag)
- Applications: [theory](04-recommender) and [lab](lab-08-recommender)
